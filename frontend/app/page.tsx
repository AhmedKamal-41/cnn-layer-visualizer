          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 lg:p-16 border border-gray-200/50">
                {/* Saved example badge — honest framing */}
                <div className="mb-4 inline-flex items-center gap-1.5 rounded-full border border-zinc-200 bg-zinc-50 px-2.5 py-0.5 text-[11px] font-medium text-zinc-600 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400">
            ...
            {isLoadingModels ? (
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                {[0, 1, 2].map((i) => (
                  ...
                  >
                    ...
                    <div className="mt-3 h-3 w-32 animate-pulse rounded bg-zinc-200 dark:bg-zinc-800" />
              ...
              <div className="rounded-xl border border-red-200 bg-red-50 p-6 text-center dark:border-red-900/50 dark:bg-red-950/30">
                <p className="text-sm text-red-700 dark:text-red-300">
                  Could not load models. The backend may be sleeping.
                </p>
                <button
                  onClick={fetchModels}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-4 md:gap-6">
              {[
                ...
                <div key={step.num} className="flex gap-4 md:block md:text-center">
                  <div className="flex-shrink-0">
                    <div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-full flex items-center justify-center text-xl font-bold md:mx-auto md:mb-4 shadow-lg">
                      {step.num}
                    </div>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1 md:mb-2">{step.title}</h3>
